$(() => { 
	...
	let data = {
		"pearl_type": [
			...
			{"name": "5.5", "label": "5.5 X 6mm", "thumb": "products/pearlsize1.png", "thumb_size": "17" ,"price": 110},
			{"name": "6.0", "label": "6 X 6.5mm", "thumb": "products/pearlsize2.png", "thumb_size": "19" ,"price": 110},
			{"name": "6.5", "label": "6.5 X 7mm", "thumb": "products/pearlsize3.png", "thumb_size": "21" ,"price": 110},
			{"name": "7.0", "label": "7.5 X 8mm", "thumb": "products/pearlsize4.png", "thumb_size": "23" ,"price": 110},
			{"name": "7.5", "label": "8 X 8.5mm", "thumb": "products/pearlsize5.png", "thumb_size": "25" ,"price": 110},
			{"name": "8.5", "label": "8.5 X 9mm", "thumb": "products/pearlsize6.png", "thumb_size": "27" ,"price": 110}
		], "necklace_length": [
		...
		load_btn(data.pearl_size, ".wrapper_pearl_size");
		load_btn(data.pearl_type, ".wrapper_pearl_type");
		load_btn(data.necklace_length, '.wrapper_length');
		load_btn(data.pearl_quality, '.wrapper_pearl_quality');
		load_btn(data.clasp, '.wrapper_clasp');
		...
		function load_btn(data, place){// place = ".wrapper" (string)
			for(item in data) {
				...
				var img_box = $(place+" .new").find(".image.thumb");
				if(img_box.length) img_box.attr("src", "statics/img/" + data[item].thumb);
				$(place+" .new").removeClass("new");
				if(data[item].thumb_size) img_box.css({'width': data[item].thumb_size+'px', 'margin-top': data[5].thumb_size-data[item].thumb_size+'px'});
			}
		}
