        ...
        <div class="build-content">
            ...
            <div class="options">
                ...
                <div class="summary">
                    ...
                    <div class="column">
                        <strong>Pearl pair selection</strong><br />
                        ...
                        <a href="build-your-own-earrings-1.php">Edit your selection</a><br />
                    </div>
                    <div class="column">
                        <strong>Setting selection</strong><br />
                        Lorem: Dolor sit amet<br />
                        Consectetur: Adipiscing<br />
                        Fusce: Varius egestas<br />
                        Mollis: Integer turpis<br />
                        Proin elit: Risus varius<br />
                        <a href="build-your-own-earrings-2.php">Edit your selection</a><br />
                    </div>
                    <div class="clear"><!-- --></div>
                </div>
                <div class="share">
